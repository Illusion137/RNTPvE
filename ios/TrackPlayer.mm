...
- (void)updateTrackUrl:(double)trackIndex track:(nonnull NSDictionary *)track resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  [nativeTrackPlayer updateTrackUrlFor:trackIndex trackDict:track resolve:resolve reject:reject];
}
...
- (void)getEqualizer:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  [nativeTrackPlayer getEqualizerWithResolve:resolve reject:reject];
}

- (void)removeEqualizer:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
...
- (void)updateSabrPoToken:(nonnull NSString *)outputPath poToken:(nonnull NSString *)poToken resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
